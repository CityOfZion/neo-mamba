...
class Block(payloads.IInventory):
    ...
    def deserialize(self, reader: serialization.BinaryReader) -> None:
        ...
        self.transactions = reader.read_serializable_list(payloads.Transaction, max=self.MAX_TX_PER_BLOCK)
...
class TrimmedBlock(serialization.ISerializable):
    ...
    def deserialize(self, reader: serialization.BinaryReader) -> None:
        self.header = reader.read_serializable(Header)
        self.hashes = reader.read_serializable_list(types.UInt256, max=Block.MAX_TX_PER_BLOCK)
...
class MerkleBlockPayload(serialization.ISerializable):
    ...
    def deserialize(self, reader: serialization.BinaryReader) -> None:
        ...
        """
        self.header = reader.read_serializable(Header)
        self.tx_count = reader.read_var_int()
