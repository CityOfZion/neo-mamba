...
@register("System.Json.Serialize", 1 << 12, contracts.native.CallFlags.NONE, [vm.StackItem])
...
@register("System.Json.Deserialize", 1 << 14, contracts.native.CallFlags.NONE, [bytes])
