...
@register("System.Binary.Serialize", 1 << 12, contracts.native.CallFlags.NONE, [vm.StackItem])
...
@register("System.Binary.Deserialize", 1 << 14, contracts.native.CallFlags.NONE, [bytes])
...
@register("System.Binary.Base64Encode", 1 << 12, contracts.native.CallFlags.NONE, [bytes])
def base64_encode(engine: contracts.ApplicationEngine, data: bytes) -> str:
    return base64.b64encode(data).decode()


@register("System.Binary.Base64Decode", 1 << 12, contracts.native.CallFlags.NONE, [bytes])
def base64_decode(engine: contracts.ApplicationEngine, data: bytes) -> bytes:
    return base64.b64decode(data)


@register("System.Binary.Base58Encode", 1 << 12, contracts.native.CallFlags.NONE, [bytes])
def base58_encode(engine: contracts.ApplicationEngine, data: bytes) -> str:
    return base58.b58encode(data).decode()


@register("System.Binary.Base58Decode", 1 << 12, contracts.native.CallFlags.NONE, [bytes])
def base58_decode(engine: contracts.ApplicationEngine, data: bytes) -> bytes:
    return base58.b58decode(data)


@register("System.Binary.Itoa", 1 << 12, contracts.native.CallFlags.NONE, [vm.BigInteger, int])
...
@register("System.Binary.Atoi", 1 << 12, contracts.native.CallFlags.NONE, [str, int])
