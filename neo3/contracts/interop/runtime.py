...
@register("System.Runtime.Platform", 1 << 3, contracts.native.CallFlags.NONE)
def get_platform(engine: contracts.ApplicationEngine) -> str:
    return "NEO"


@register("System.Runtime.GetTrigger", 1 << 3, contracts.native.CallFlags.NONE)
def get_trigger(engine: contracts.ApplicationEngine) -> vm.BigInteger:
    return vm.BigInteger(engine.trigger.value)


@register("System.Runtime.GetTime", 1 << 3, contracts.native.CallFlags.NONE)
def get_time(engine: contracts.ApplicationEngine) -> int:
    return engine.snapshot.persisting_block.timestamp


@register("System.Runtime.GetScriptContainer", 1 << 3, contracts.native.CallFlags.NONE)
...
@register("System.Runtime.GetExecutingScriptHash", 1 << 4, contracts.native.CallFlags.NONE)
def get_executingscripthash(engine: contracts.ApplicationEngine) -> types.UInt160:
    return engine.current_scripthash


@register("System.Runtime.GetCallingScriptHash", 1 << 4, contracts.native.CallFlags.NONE)
def get_callingscripthash(engine: contracts.ApplicationEngine) -> types.UInt160:
    return engine.calling_scripthash


@register("System.Runtime.GetEntryScriptHash", 1 << 4, contracts.native.CallFlags.NONE)
def get_entryscripthash(engine: contracts.ApplicationEngine) -> types.UInt160:
    return engine.entry_scripthash


@register("System.Runtime.CheckWitness", 1 << 10, contracts.native.CallFlags.NONE, [bytes])
...
@register("System.Runtime.GetInvocationCounter", 1 << 4, contracts.native.CallFlags.NONE)
def get_invocationcounter(engine: contracts.ApplicationEngine) -> int:
    return engine.get_invocation_counter()


@register("System.Runtime.Log", 1 << 15, contracts.native.CallFlags.ALLOW_NOTIFY, [bytes])
...
@register("System.Runtime.Notify", 1 << 15, contracts.native.CallFlags.ALLOW_NOTIFY, [bytes, vm.ArrayStackItem])
...
@register("System.Runtime.GetNotifications", 1 << 8, contracts.native.CallFlags.NONE, [types.UInt160])
...
@register("System.Runtime.GasLeft", 1 << 4, contracts.native.CallFlags.NONE)
