...
@register("System.Storage.GetContext", 1 << 4, contracts.native.CallFlags.READ_STATES, [])
...
@register("System.Storage.GetReadOnlyContext", 1 << 4, contracts.native.CallFlags.READ_STATES, [])
...
@register("System.Storage.AsReadOnly", 1 << 4, contracts.native.CallFlags.READ_STATES, [storage.StorageContext])
...
@register("System.Storage.Get", 1 << 15, contracts.native.CallFlags.READ_STATES, [storage.StorageContext, bytes])
...
@register("System.Storage.Find", 1 << 15, contracts.native.CallFlags.READ_STATES, [storage.StorageContext, bytes])
...
@register("System.Storage.FindKeys", 1 << 15, contracts.native.CallFlags.READ_STATES)
...
@register("System.Storage.Put", 0, contracts.native.CallFlags.WRITE_STATES, [storage.StorageContext, bytes, bytes])
...
@register("System.Storage.PutEx", 0, contracts.native.CallFlags.WRITE_STATES,
...
@register("System.Storage.Delete", 0, contracts.native.CallFlags.WRITE_STATES, [storage.StorageContext, bytes])
