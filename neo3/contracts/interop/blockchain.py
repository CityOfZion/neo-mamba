...
@register("System.Blockchain.GetHeight", 1 << 4, contracts.native.CallFlags.READ_STATES, True)
...
@register("System.Blockchain.GetBlock", 1 << 16, contracts.native.CallFlags.READ_STATES, True, [bytes])
...
@register("System.Blockchain.GetTransactionFromBlock", 1 << 15, contracts.native.CallFlags.READ_STATES, True,
          [bytes, int])
...
@register("System.Blockchain.GetTransaction", 1 << 15, contracts.native.CallFlags.READ_STATES, True, [types.UInt256])
...
@register("System.Blockchain.GetTransactionHeight", 1 << 15, contracts.native.CallFlags.READ_STATES, True,
          [types.UInt256])
