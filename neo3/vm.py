...
class Syscalls:
    ...
    #: Delete an entry from local storage under a specified key.
    SYSTEM_STORAGE_LOCAL_DELETE = Syscall(
        "System.Storage.Local.Delete", callflags.CallFlags.WRITE_STATES
    )
