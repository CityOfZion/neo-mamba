...
you to sign and relay transactions to the network. We decided to drop Python 3.7 support as the last bug fix release
...
to stay up to date. Expect a move to Python 3.9 in the near future.
