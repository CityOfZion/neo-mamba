...
class WalletCreationTestCase(unittest.TestCase):
    ...
    def test_wallet_save(self):
        ...
        wallet_read = Wallet.from_json(data)
        self.assertEqual(wallet_read.name, wallet.name)
        self.assertEqual(wallet_read.version, wallet.version)
        self.assertEqual(wallet_read.scrypt.n, wallet.scrypt.n)
        self.assertEqual(wallet_read.scrypt.r, wallet.scrypt.r)
        self.assertEqual(wallet_read.scrypt.p, wallet.scrypt.p)
        self.assertEqual(wallet_read.accounts, wallet.accounts)
        self.assertEqual(wallet_read.extra, wallet.extra)
